...
> carrier, so a click puts it above the signal and the two tones either side of 2210 Hz.
> YWC takes the tone frequencies from the radio's RTTY MARK and SHIFT menus (2125 Hz and
> 170 Hz by default), which is also the usual default in RTTY software. If yours is set
> differently, the click lands a little off.
>
