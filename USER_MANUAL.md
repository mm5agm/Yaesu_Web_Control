...
5. Other controls:
   ...
   - **Fit / Fill** — two-button toggle on the video bar: **Fit** (`object-fit: contain`, whole TFT visible) or **Fill** (cover, pane filled and edges may crop). On the Index card, **Fill** keeps the whole TFT visible and may letterbox with black bars beside the picture on a wide screen; the pop-out window may crop edges instead.
