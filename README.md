...
|---|---|---|
| The spectrum panel was a fixed 280 pixels tall, on a 4K monitor as much as on a laptop, and nothing could be done about it. It now takes a **Height** setting on its control bar — Short through Tallest — and the bottom-right corner of the panel can be dragged to any size between the two ends, remembered per VFO ([§5.4](USER_MANUAL.md#54-spectrum-display)). | [#171](https://github.com/mm5agm/Yaesu_Web_Control/discussions/171) | Not yet in a build |
