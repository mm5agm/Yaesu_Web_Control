...
|---|---|---|
| The spectrum panel was a fixed 280 pixels tall, on a 4K monitor as much as on a laptop, and nothing could be done about it. It now takes a **Height** setting on its control bar — Shortest through Tallest — and a grip along the bottom of the panel can be dragged (or driven from the keyboard) to anything from 40 to 1000 pixels, remembered per VFO ([§5.4](USER_MANUAL.md#54-spectrum-display)). | [#171](https://github.com/mm5agm/Yaesu_Web_Control/discussions/171) | Not yet in a build |
